...
// LAN H/W parameters
	...
	{ "ntpd_server", "0" },
	{ "ntp_log_x", "1" },	// log successful NTP updates
	{ "ntp_update", "1" },	// ntp update interval in hours
...
//
	...
	{ "qos_atm",			"0",				}, // 2 = PTM (Cake only), 1 = ATM, 0 = Ethernet
	{ "qos_mpu",			"0",				},
	{ "qos_method",			"0"				},
	{ "qos_sticky",			"1"				},
	{ "qos_ack",			"on"				},
	...
	{ "ttl_spoof_value", "65"},		// default spoof TTL
	{ "DSCP_fix_enable", "0" },
...
//#endif
	...
	{ "ipv6_dhcp6c_release","1"		},	// Address release by DHCP6C
