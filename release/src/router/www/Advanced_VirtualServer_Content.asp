...
function showvts_rulelist(){
	...
	if(vts_rulelist_row.length == 1)
		...
		for(var i = 1; i < vts_rulelist_row.length; i++){
			...
			if(source_target.length >18){
				overlib_src[i] += source_target;
				source_target = source_target.substring(0, 16)+"...";
		...
		<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" class="FormTable_table">
			...
			<th><a class="hintstyle" href="javascript:void(0);" onClick="">Source IP</a></th>
  				...
  				<td style="width:148px">
  					<input type="text" maxlength="30" class="input_15_table" name="vts_target_x_0" onKeyPress="return is_string(this, event)" autocorrect="off" autocapitalize="off"/>
				...
				<td style="width:157px">
					<input type="text" maxlength="15" class="input_12_table" name="vts_ipaddr_x_0" align="left" onkeypress="return is_ipaddr(this, event)" style="float:left;"/ autocomplete="off" onClick="hideClients_Block();" autocorrect="off" autocapitalize="off">
