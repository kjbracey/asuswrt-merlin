...
function openvpn_decodeKeys(entities){
	...
	document.getElementById('edit_vpn_crt_server1_crl').value = document.getElementById('edit_vpn_crt_server1_crl').value.replace(expr,"\r\n");
	...
	document.getElementById('edit_vpn_crt_server2_crl').value = document.getElementById('edit_vpn_crt_server2_crl').value.replace(expr,"\r\n");
...
function update_visibility(){
	...
	ncp = document.openvpn_form.vpn_server_ncp_enable.value;
	comp = document.openvpn_form.vpn_server_comp.value;
...
function cancel_Key_panel(auth){
	if((auth == 'tls') || (auth == "secret")){
			...
			if (openvpn_unit == 1) {
				...
				setTimeout("document.getElementById('edit_vpn_crt_server1_crl').value = '<% nvram_clean_get("vpn_crt_server1_crl"); %>';", 300);
				...
				setTimeout("document.getElementById('edit_vpn_crt_server2_crl').value = '<% nvram_clean_get("vpn_crt_server2_crl"); %>';", 300);
...
<!-- Yau -->
			...
			<input type="hidden" name="vpn_crt_server1_crl" value="<% nvram_clean_get("vpn_crt_server1_crl"); %>">
			...
			<input type="hidden" name="vpn_crt_server2_crl" value="<% nvram_clean_get("vpn_crt_server2_crl"); %>">
                			...
                			<td valign="top">
								...
								<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3"  class="FormTable" style="margin-top:8px;">
									...
									<tr id="ncp_ciphers">
										...
										<td>
											<input type="text" maxlength="127" class="input_32_table" name="vpn_server_ncp_ciphers" value="<% nvram_get("vpn_server_ncp_ciphers"); %>" >
										</td>
									</tr>
									<tr id="server_cipher">
								...
								<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" class="FormTable_table" id="openvpn_client_table">
									...
									<tr>							
										...
										<td width="36%">
						 					<input type="text" class="input_25_table" maxlength="64" name="vpn_clientlist_commonname_0"  onKeyPress="">
						 				</td>
										<td width="20%">
