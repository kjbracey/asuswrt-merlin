...
function onEvent(){
	...
	if(get_manage_type(PROTOCOL) == 1 && accounts.length <= 15){
		...
		$("createAccountBtn").onmouseover = function(){};
		$("createAccountBtn").onmouseout = function(){};
		$("createAccountBtn").title = (accounts.length <= 15)?"<#AddAccountTitle#>":"<#account_overflow#>";
	}
		  ...
		  <div>&nbsp;</div>
			...
			<table width="740px" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
				...
				<th><#AiDisk_Guest_Login#></th>
					...
					<td>
						<input type="text" name="st_max_user" class="input_3_table" maxlength="2" value="<% nvram_get("st_max_user"); %>" onKeyPress="return is_number(this, event);">
					</td>
				</tr>
				<tr>
					<th>
				...
				<tr>
					...
					<td>
						<input type="text" name="st_samba_workgroup" class="input_20_table" maxlength="15" value="<% nvram_get("st_samba_workgroup"); %>">
					</td>
				</tr>
				<tr>
