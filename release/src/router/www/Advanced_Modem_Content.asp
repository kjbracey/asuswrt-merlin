...
var	usb_modem_enable = '<% nvram_get("modem_enable"); %>';
<% wan_get_parameter(); %>
...
function switch_modem_mode(mode){
	...
	if(mode == "1"){ // WCDMA
		...
		document.getElementById("ttl_div_tr").style.display = "";
		...
		document.getElementById("ttl_div_tr").style.display = "none";
...
function hide_usb_settings(_flag){
	...
	document.getElementById("ttl_div_tr").style.display = ((typeof(_flag) != 'undefined' && _flag) ? "" : "none");
}
...
<input type="hidden" name="web_redirect" value="<% nvram_get("wan_redirect"); %>">
	  ...
	  <table width="760px" border="0" cellpadding="5" cellspacing="0" class="FormTitle" id="FormTitle" style="-webkit-border-radius: 3px;-moz-border-radius: 3px;border-radius:3px;">
		...
		<tr>
			...
			<div class="formfontdesc"><#HSDPAConfig_hsdpa_enable_hint1#></div>
				...
				<div id="ttl_div_tr" style="display:none";>
				<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3"  class="FormTable" style="margin-top:8px">
				<thead>
				<tr>
