      ...
      <div class="formfontdesc"><#adv_wl_desc#></div>
			...
			<table width="99%" border="1" align="center" cellpadding="4" cellspacing="0" id="WLgeneral" class="FormTable">
				...
				<tr>
					...
					<td>
						<input type="text" maxlength="32" class="input_32_table" id="wl_ssid" name="wl_ssid" value="<% nvram_get("wl_ssid"); %>" onkeypress="return is_ssidstring(this, event)">
					</td>
		  	</tr>
			  ...
			  <tr>
			  	...
			  	<tr>
					...
					<td>
						<input id="wl_wpa_psk" name="wl_wpa_psk" maxlength="64" class="input_32_table" autocorrect="off" autocapitalize="off" autocomplete="new-password" type="password" readonly onBlur="switchType(this, false);" onFocus="switchType(this, true); $(this).removeAttribute('readonly');" value="<% nvram_get("wl_wpa_psk"); %>">
					</td>
			  	</tr>
